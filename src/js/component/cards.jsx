      ...
      <Row>
        {Array.from({ length: 20 }).map((_, index) => (
          <Col key={index} xs={12} sm={12} md={6} lg={4} xl={3}>
            <div className="card w-80 d-flex flex-column align-items-center justify-content-center m-3" style={{ minWidth: "250px", maxWidth: "500px" }}>
              ...
              <div className="card-body text-center">
                ...
                <p className="card-text text-dark" style={{ fontSize: "0.85rem" }}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quaerat quae quo blanditiis rerum tempora labore nostrum similique vitae porro laborum. Voluptatibus laborum illo voluptate tempora aliquid iure consectetur alias id?.</p>
